...
<section class="container-fluid signupintro">
 ...
 <div class="row">
                <div class="col-md-4 followerstyle "><h2 class="followertab"><?php the_field('followertab'); ?></h2>
                    <h2><?php the_field('followerheading'); ?></h2><p><?php the_field('followerinfo'); ?></p><a href="<?php the_field('followerlink'); ?>"class="btn learn btn-primary-plan" href="#" role="button">Become a Follower</a>
                </div><div class="col-md-4 fanstyle "><h2 class="fantab"><?php the_field('fantab'); ?></h2>
                    <h2><?php the_field('fanheading'); ?></h2><p><?php the_field('faninfo'); ?></p><a href="<?php the_field('fanlink'); ?>"class="btn learn btn-primary-plan" href="#" role="button">Become a Fan</a>
                </div><div class="col-md-4 friendstyle "><h2 class="friendtab"><?php the_field('friendtab'); ?></h2>
                    <h2><?php the_field('friendheading'); ?></h2><p><?php the_field('friendinfo'); ?></p><a href="<?php the_field('friendlink'); ?>"class="btn learn btn-primary-plan" href="#" role="button">Become a Friend</a>
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    </section>

...
<section class="container-fluid signupintro">
 ...
 <div class="row">
                ...
                <h2 class="fantab"><?php the_field('fantab'); ?></h2></div><div class="col-md-4">
                <h2 class="friendtab"><?php the_field('friendtab'); ?></h2></div>
            </div> <!-- row -->
        </div> <!-- container -->
    </section>
    <section class="container-fluid plansdescription">
        <div class="container">
 <div class="row">
                <div class="col-md-4 followerstyle ">
                ...
                </div><div class="col-md-4 fanstyle ">
                ...
                </div><div class="col-md-4 friendstyle ">

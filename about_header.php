...
<body>
<header class="container-fluid" style="background-size: cover; background-image: url(<?php the_field('aboutbackground') ?>);"><!-- div for the main image the stretches to the edge of the page- -->
